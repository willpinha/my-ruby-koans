...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # Because they try to match as many characters as possible.
  ...
  #
  # A character class is a set of characters that can be matched, while alternation is a choice between two or more
  # patterns.
