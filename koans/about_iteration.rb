...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Accumulates a value by applying a block to each element of an array.
  end
  ...
  #
  # The first way is better because it automatically closes the file when the block is done.
end
